...
import net.quepierts.animata4j.core.data.tree.impl.ImmutableTree;
import net.quepierts.animata4j.core.data.tree.PathResolvable;
import net.quepierts.animata4j.core.data.tree.definition.TreeStructureBuilder;
