...
public final class FieldDefinition {
    private final VeynirDataType primaryType;
    private final String type;
    private final String name;
    private final int length;

    public static FieldDefinition.Builder primitive(VeynirDataType primaryType) {
    ...
    public static FieldDefinition.Builder struct(String type) {
        return new FieldDefinition.Builder(VeynirDataType.STRUCT, type);
    }

    private FieldDefinition(VeynirDataType primaryType, String type, String name, int length) {
        this.length = length;
        if (!VeynirDataType.isAvailableType(type)) {
