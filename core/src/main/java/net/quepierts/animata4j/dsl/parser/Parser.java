...
import net.quepierts.animata4j.dsl.ast.type.PrimitiveType;
import net.quepierts.animata4j.dsl.ast.type.StructType;
import net.quepierts.animata4j.dsl.ast.type.Type;
import net.quepierts.animata4j.dsl.ast.type.VoidType;
import net.quepierts.animata4j.dsl.exception.ParserException;
import net.quepierts.animata4j.dsl.lexer.Token;
import net.quepierts.animata4j.dsl.lexer.TokenProvider;
