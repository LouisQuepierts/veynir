...
import net.quepierts.animata4j.dsl.ast.AccessPathNode;
import net.quepierts.animata4j.dsl.ast.Node;
import net.quepierts.animata4j.dsl.ast.expr.ArrayAccessExpr;
import net.quepierts.animata4j.dsl.ast.expr.Expression;
import net.quepierts.animata4j.dsl.ast.expr.IdentifierExpr;
import net.quepierts.animata4j.dsl.lexer.CacheLexer;
