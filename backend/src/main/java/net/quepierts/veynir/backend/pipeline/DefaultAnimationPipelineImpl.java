...
import net.quepierts.veynir.core.channel.ChannelFormatElement;
import net.quepierts.veynir.core.channel.ChannelLayout;
import net.quepierts.veynir.core.channel.DefaultChannelFormats;
...
import net.quepierts.veynir.core.pipeline.*;
...
public final class DefaultAnimationPipelineImpl implements AnimationPipeline {
    ...
    public void bindSource(
            final String                    name,
            final AnimationSamplerObject    sampler
    ) {
    ...
    public void bindSource(
        ...
        this.samplers[location] = (AnimationSampler) sampler;
    }

    @Override
    public void bindUbo(
            final String                name,
            final UniformBufferObject   buffer
    ) {
    ...
    public void bindUbo(
        ...
        this.ubos[location]     = (UniformBuffer) buffer;
    }
    ...
    private static final class Context implements AnimationContext {
        ...
        private Context(
            ...
            this.attributeSize = format.getAttributeSize();
        ...
        public @NonNull AnimationBuffer getParameterBuffer() {
            return (AnimationBuffer) this.state.getParameterBuffer();
        }
        ...
        public boolean getChannelMask(int channel) {
            ...
            return !this.hasMaskElement
                    || this.state.getChannelAttribute()
                        .readBoolean(channel * this.attributeSize + this.enableOffset);
        }
    }
