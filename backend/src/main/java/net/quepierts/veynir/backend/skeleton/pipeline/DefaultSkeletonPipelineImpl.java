...
import net.quepierts.veynir.core.pipeline.ExecutionReflection;
import net.quepierts.veynir.core.pipeline.PoseBuffer;
import net.quepierts.veynir.core.pipeline.SkeletonContext;
import net.quepierts.veynir.core.pipeline.SkeletonOutput;
import net.quepierts.veynir.core.pipeline.SkeletonPipeline;
import net.quepierts.veynir.core.pipeline.SkeletonPoseProvider;
...
import net.quepierts.veynir.backend.skeleton.exception.UnboundProviderException;
...
public final class DefaultSkeletonPipelineImpl implements SkeletonPipeline {
    ...
    private final PoseBuffer                result;
