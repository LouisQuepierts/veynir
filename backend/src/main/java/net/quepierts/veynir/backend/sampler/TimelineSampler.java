...
public final class TimelineSampler implements AnimationSampler {
    ...
    public void sample(
        ...
        if (mode != net.quepierts.veynir.core.pipeline.SamplingMode.DEFAULT) {
    ...
    private void directSample(
            ...
            net.quepierts.veynir.core.pipeline.SamplingMode mode
    ) {

        final var max           = mode == net.quepierts.veynir.core.pipeline.SamplingMode.FREEZE_END;
